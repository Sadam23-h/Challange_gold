...
info = {
    'title': LazyString(lambda:'API for Cleansing Data by Sadam '),
    'version' : LazyString(lambda: '1.0.0'),
    'description' : LazyString(lambda: 'API for Cleansing Data by Sadam'),
    },
...
@app.route('/')
def hello():
    return "Welcome to the API for Data Cleansing by Sadam >>>>>>>>> Challenge Binar DSC Wave 6"
